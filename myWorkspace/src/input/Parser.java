...
//parser is meant to read the xml file with the pool of questions

public class Parser {
	//the class contains a list of questions which will be extracted from the xml file
	...
	//get and set methods are used in order to access and modify the questions and the file
	...
	private void parserDocument(Document doc) {
		...
		// To initialize the document as a tree
